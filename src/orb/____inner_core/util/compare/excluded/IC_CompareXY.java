...
public class IC_CompareXY { //implements _CompareXY {
    ...
    public static int compare(double aX, double bX) {
        if      (aX < bX) return -1;
    ...
    public static int compareX(double aX, double bX) {
        return compare(aX, bX);
    }

    public static int compareY(double aY, double bY) {
    ...
    public static int compareXY(double aX, double aY, double bX, double bY) {
    ...
    public static int compareYX(double aX, double aY, double bX, double bY) {
    ...
    public static int compareDistSqToPoint(double aX, double aY, double bX, double bY, double x, double y) {
    ...
    public static int compareDistSqToPoint(_Vec2 a, _Vec2 b, double x, double y) {
    ...
    public static int compareDistToPoint(double aX, double aY, double bX, double bY, double x, double y) {
    ...
    public static int compareDistToPoint(_Vec2 a, _Vec2 b, double x, double y) {
    ...
    public static int compareAngleToPoint(double aX, double aY, double bX, double bY, double x, double y) {
    ...
    public static int compareAngleToPoint(_Vec2 a, _Vec2 b, double x, double y) {

...
public class OC_XYZComparator<T> extends OC_ComparatorsXY<T> {
    ...
    public OC_XYZComparator(_GetDoubleT<T> getX, _GetDoubleT<T> getY, _GetDoubleT<T> getZ) {
        super(getX, getY);
    ...
    public int compareZ(T a, T b) {
        ...
        final double aZ = getZ.val(a);
        final double bZ = getZ.val(b);
    ...
    public int compareDistToPoint3D(T a, T b, double x, double y, double z) {
        double dA = distSq(getX.val(a), getY.val(a), getZ.val(a), x, y, z);
        double dB = distSq(getX.val(b), getY.val(b), getZ.val(b), x, y, z);

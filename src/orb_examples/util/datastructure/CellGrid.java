...
import nl.doekewartena.orb.crust.util.datastructure.C_CellGrid;
...
public class CellGrid extends Problessing {
    ...
    public void draw() {
        ...
        OC_CellGrid.OC_Cell_2D hot = cellGrid.getCell((double)mouseX, (double)mouseY);
        ...
        OC_CellGrid.OC_Cell_2D currentClosest = cellGrid.getCell((double) mouseX, (double) mouseY);
